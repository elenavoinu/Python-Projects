...
#Each stub should print "FIXME: Finish function_name()" followed by a newline, 
#and should return -1. Each stub must also contain the function's parameters. 
#Example output: FIXME: Finish get_user_num()
